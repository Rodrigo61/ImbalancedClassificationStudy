...
sleep 20 | condor_submit submission_files/acc_xgboost_false.sub
sleep 20 | condor_submit submission_files/acc_xgboost_true.sub
...
sleep 20 | condor_submit submission_files/f1_xgboost_false.sub
sleep 20 | condor_submit submission_files/f1_xgboost_true.sub
...
sleep 20 | condor_submit submission_files/gmeans_xgboost_false.sub
sleep 20 | condor_submit submission_files/gmeans_xgboost_true.sub
...
sleep 20 | condor_submit submission_files/mcc_xgboost_false.sub
sleep 20 | condor_submit submission_files/mcc_xgboost_true.sub
