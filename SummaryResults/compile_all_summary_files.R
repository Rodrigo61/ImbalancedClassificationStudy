...
summary_list = read.csv(SUMMARY_LIST_FILENAME, header = F)

df_final = NULL

for(summary_file_name in summary_list){
  
  summary = reade.csv(summary_file_name, header = T)
...
print_debug(paste("Summary compilado e salvo em: ", out_filename, sep=""))